...
module.exports = function(appName, appVersion, appTempPath, binding) {
...
class CrashReporter {
  start (options) {
    ...
    this.productName = options.productName != null ? options.productName : appName
  ...
  getTempDirectory () {
    if (this.tempDirectory == null) {
      try {
        ...
        this.tempDirectory = appTempPath
      } catch (error) {
